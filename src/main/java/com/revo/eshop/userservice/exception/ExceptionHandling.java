package com.revo.eshop.userservice.exception;

import com.auth0.jwt.exceptions.TokenExpiredException;
import com.revo.eshop.userservice.exception.domain.EmailExistException;
import com.revo.eshop.userservice.exception.domain.EmailNotFoundException;
...
import com.revo.eshop.userservice.ui.model.HttpResponse;
...
public class ExceptionHandling implements ErrorController {
    ...
    public ResponseEntity<HttpResponse> methodNotSupportedException(NoHandlerFoundException exception) {
        return createHttpResponse(METHOD_NOT_ALLOWED, "Page was not found");
    }
